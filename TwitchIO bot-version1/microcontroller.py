...
class Microcontroller():
    ...
    def __init__(self,parent=None):
        ...
        # detecting for Arduino: I'll just comment them for now
        # self.serial = None
        ...
        # 1st Testing: testing connection to Microcontroller.py --> Success
        print("\n --> Successfully connecting to microcontroller! \n")
